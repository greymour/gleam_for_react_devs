...
function component(init3, update3, view2, on_attribute_change) {
  return new App(init3, update3, view2, new Some(on_attribute_change));
}

// build/dev/javascript/lustre/client-component.ffi.mjs
function register({ init: init3, update: update3, view: view2, on_attribute_change }, name2) {
  if (!is_browser())
    return new Error(new NotABrowser());
  if (!name2.includes("-"))
  ...
  window.customElements.define(
    name2,
    makeComponent(init3, update3, view2, on_attribute_change)
  );
  return new Ok(void 0);
}
function makeComponent(init3, update3, view2, on_attribute_change) {
  return class LustreClientComponent extends HTMLElement {
    ...
    constructor() {
      super();
      on_attribute_change[0]?.forEach((decoder2, name2) => {
...
function app() {
  return component(init2, update2, view, new$());
}
